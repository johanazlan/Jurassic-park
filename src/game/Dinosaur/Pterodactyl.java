...
public class Pterodactyl extends Dinosaur {
    ...
    public Action playTurn(Actions actions, Action lastAction, GameMap map, Display display) {
        ...
        System.out.println(this.name + " Hitpoints: "+ hitPoints + " Thirst Level: " + this.getThirst_level() + " Flying Turn: " + flyingTurn);
    ...
    public void checkFlying(GameMap map){
        ...
        else if(this.isConscious() && flyingTurn > 30 && this.hasCapability(DinosaurCapability.Status.FLYING)){
