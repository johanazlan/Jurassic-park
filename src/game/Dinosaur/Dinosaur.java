...
public abstract class Dinosaur extends Actor {
     ...
     */
    private int pregnant_time = 0, age, unconsciousTurn = 0, thirst_level = 61, unconsciousDueToThirst = 0;
     ...
     * @param thirst_level thirst level of the dinosaur
     */
    public void setThirst_level(int thirst_level) {
        this.thirst_level = Math.min(thirst_level, MAX_WATER_CAP);
    }
